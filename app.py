...
# from dashboard.utils import (reading_cleaning,plots,comparison,histogram,
#                              corr_with_left,distribution,prediction,
#                              employee_important_info)
...
def placement():
    if request.method == 'POST':
        ...
        result = prediction(model,scaler,sl_no, gender, ssc_p, hsc_p, degree_p, workex, etest_p, specialisation, mba_p)
